 ...
 *   https://datatables.net/download/#dt/dt-2.3.5/cc-1.1.1/fh-4.0.5
 *
 * Included libraries:
 *   DataTables 2.3.5, ColumnControl 1.1.1, FixedHeader 4.0.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.3.5/cc-1.1.1/fh-4.0.5",
